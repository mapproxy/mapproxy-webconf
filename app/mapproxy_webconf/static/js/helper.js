...
helper.clearData = function(dict) {
    angular.forEach(angular.copy(dict), function(value, key) {
        if(typeof(value) == 'boolean') {
            ...
            if(helper.isEmpty(value)) {
                ...
                dict[key] = helper.clearData(value);
            }
        }
    });
    return dict;
...
helper.nameExistInService = function(name, id, service, services) {
    var found = false;
...
helper.safeApply = function(scope, fn) {
...
helper.safePreventDefaults = function(event) {
...
helper.generateInfoDialogContent = function(data, TranslationService) {
